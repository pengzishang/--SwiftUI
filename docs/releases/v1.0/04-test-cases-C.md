...
当前仓库只有 PRD，尚无 SwiftUI 源码或 Xcode 工程。本测试用例基于 `docs/releases/v1.0/01-product-requirements.md` 和接口文档 `docs/releases/v1.0/03-api-document-B.md` 编写，用于指导后续开发、mock 服务、自动化测试和监工验收。
