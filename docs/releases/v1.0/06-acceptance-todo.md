...
- 第 1-7 节记录首轮验收完成状态。
- 第 8 节记录第二轮最新开放项；第 8 节未全部关闭前，第二轮不准出。
...
- [x] 保存亮色首页截图。
  - 证据：`docs/releases/v1.0/acceptance-reports/20260621-acceptance-evidence/home-light.png`。
- [x] 保存深色首页截图。
  - 证据：`docs/releases/v1.0/acceptance-reports/20260621-acceptance-evidence/home-dark.png`。
- [x] 记录构建/测试环境。
  - 证据：Xcode 26.5 / Build 17F42；iPhone 17 Simulator；iOS 26.5。
- [x] 记录测试总数与结论。
  - 证据：`xcodebuild test` 通过，`xcresulttool` 摘要显示 `29/29 passed`。

### 6.4 监工验收 agent 首轮衍生项
...
第三轮最新结论：通过。第三轮已修复第二轮 P0/P1 开放项，并归档完整 scheme 测试结果：`docs/releases/v1.0/acceptance-reports/20260621-third-round-evidence/final-full-scheme-ios26-r3.xcresult`，结果为 38 passed、1 skipped、0 failed；跳过项为系统分享面板 XCUITest，已按开放项要求改为手工验收替代。
